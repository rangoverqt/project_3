...
<div class="container">
    <div class="turnback"><a href="/doan3/public/hocvien/trangchu/{{$hocvien -> id}}">Trở về</a></div>
    @if($chucvu_hk == null)

    @elseif($chucvu_hk -> id_chucnang == 5)
        @if($bangdiem_yeucau > 0)
        <div class="turnback">
            <a href="/doan3/public/hocvien/bangdiem/xemyeucau/{{$bangdiem_lan1 -> id}}" style="margin-right: 20px">
                Xem yêu cầu</a>
        </div>
            @else
    <div class="turnback">
        <a href="/doan3/public/hocvien/bangdiem/yeucau/{{$bangdiem_lan1 -> id}}" style="margin-right: 20px">
            Yêu cầu xem xét</a></div>
            @endif
        @else

    @endif
    <div class="turnback">
        <a style="margin-right: 20px" href="{{route('pdfdownload_chitiet',['idbangdiem'=>$bangdiem_lan1 -> id,'download'])}}">Tải về</a>
    </div>
    <div class="tt_sv">
    ...
    <div class="bang1">
        <table class="table table1 table-bordered table-hover" style="background-color: white">
            ...
            <tr>
                ...
                <td id="diem">10</td>
                @if($bangdiem_chitiet == null)
                    <td id="diem">Sinh viên không tự chấm</td>
                    @else
                <td id="diem">
            ...
            <tr>
                ...
                @if($bangdiem_chitiet == null)
                    <td id="diem">Sinh viên không tự chấm</td>
                @elseif($bangdiem_chitiet -> p1_a_3 == 8)
            ...
            <tr>
                ...
                @if($bangdiem_chitiet == null)
                    <td id="diem">Sinh viên không tự chấm</td>
                @elseif($bangdiem_chitiet -> chungchi_a == NULL)
            ...
            <tr>
                ...
                @if($bangdiem_chitiet == null)
                    <td id="diem">Sinh viên không tự chấm</td>
                @elseif($bangdiem_chitiet -> chungchi_b == NULL)
                    <td id="diem">Chưa có</td>
                @else
            ...
            <tr>
                ...
                @if($bangdiem_chitiet == null)
                    <td id="diem">Sinh viên không tự chấm</td>
                @elseif($bangdiem_chitiet -> chungchi_c == NULL)
                    <td id="diem">Chưa có</td>
                @else
            ...
            <tr>
                ...
                @if($bangdiem_chitiet == null)
                    <td id="diem">Sinh viên không tự chấm</td>
                @elseif($bangdiem_chitiet -> toeic == NULL)
                    <td id="diem">Chưa có</td>
                @else
            ...
            <tr>
                ...
                <td></td>
                @if($tong1 == 'k' && $tong2 == 'k' && $tong3 == 'k' && $tong4 == 'k' && $tong5 == 'k')
                    <td id="diem">Sinh viên không tự chấm</td>
                    @else
    ...
    <div class="ketluan">
        <h4>Kết luận của cố vấn học tập:</h4>
        <p><strong>Điểm rèn luyện:</strong>{{$bangdiem_lan1 -> diemtong}}</p>
        <p><strong>Xếp loại:</strong> {{$bangdiem_lan1 -> xeploai}}</p>
    </div>
</div>
