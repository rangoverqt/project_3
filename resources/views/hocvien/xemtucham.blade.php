...
<div class="container">
    ...
    <div class="turnback"><a href="/doan3/public/hocvien/trangchu/{{$hocvien -> id}}">Trở về</a></div>
        <div class="turnback"><a style="margin-right: 20px" href="/doan3/public/hocvien/bangdiem/suatucham/{{$hocvien->id}}">Tự chấm lại</a></div>
        <div class="turnback">
            <a style="margin-right: 20px" href="{{route('pdfdownload',['idhocvien'=>$hocvien -> id,'download'])}}">Tải về</a>
        </div>
    <div class="tt_sv">
