...
<div class="container">
    <div class="turnback"><a href="/doan3/public/hocvien/loptruong/bangdiemlan1/{{$lop -> id}}">Trở về</a></div>
    <div class="turnback" id="duyet"><a style="margin-right: 20px" href="
    /doan3/public/hocvien/loptruong/bangdiem/{{$lop -> id}}/duyetnhanh/{{$bangdiem -> id}}">Duyệt</a></div>
    <div class="turnback"><input id="button" type="button" value="Chấm lại"></div>
    <div class="tt_sv">
        <h4>Thông tin sinh viên:</h4>
        <p><strong>Mã số sinh viên:</strong> {{$bangdiem -> hocvien -> mssv}}</p>
        <p><strong>Họ tên:</strong> {{$bangdiem -> hocvien -> hoten}}</p>
        <p><strong>Lớp:</strong> {{$bangdiem -> hocvien -> lop -> ten_lop}}</p>
    </div>
    <div class="tt_hk">
        <p><strong>Năm học: </strong>{{$bangdiem -> hocky -> namhoc -> namhoc}}</p>
        <p><strong>Học kỳ: </strong>{{$bangdiem -> hocky -> hocky}}</p>
    </div>
    <form action="" method="post">
        @csrf
        <input hidden name="hocky" value="{{$bangdiem -> hocky -> id}}">
        <div class="bang1">
            <table class="table table1 table-bordered table-hover" style="background-color: white">
                ...
                <tr>
                    ...
                    <td id="diem">10</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p1_a_1 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p1_a_1}}
                        @endif
                    </td>
                    <td id="diem">
                ...
                <tr>
                    ...
                    <td id="diem">10</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p1_a_2 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p1_a_2}}
                        @endif
                    </td>
                    <td id="diem">
                        <input placeholder="Nhập"
                ...
                <tr>
                    ...
                    <td id="diem">8</td>
                    @if($bangdiem -> bangdiem_chitiet-> p1_a_3 == 8)
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> p1_a_3}}</td>
                    @else
                        <td id="diem">Không đủ</td>
                    @endif
                    <td id="diem"><input type="checkbox" name="p1_a_3" id="cb1" value="8" class="p1_cb" hidden></td>
                </tr>
                <tr>

                    <td id="dtb">ĐTBCHK đạt  từ  3,20 đến 3,59</td>
                    <td id="diem">6</td>
                    @if($bangdiem -> bangdiem_chitiet-> p1_a_3 == 6)
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> p1_a_3}}</td>
                    @else
                        <td id="diem">Không đủ</td>
                    @endif
                    <td id="diem"><input type="checkbox" name="p1_a_3" id="cb2" value="6" class="p1_cb" hidden></td>
                </tr>
                <tr>
                    <td id="dtb">ĐTBCHK đạt  từ  2,50 đến 3,19</td>
                    <td id="diem">4</td>
                    @if($bangdiem -> bangdiem_chitiet-> p1_a_3 == 4)
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> p1_a_3}}</td>
                    @else
                        <td id="diem">Không đủ</td>
                    @endif
                    <td id="diem"><input type="checkbox" name="p1_a_3" id="cb3" value="4" class="p1_cb" hidden></td>
                </tr>
                <tr>
                    <td id="dtb">ĐTBCHK đạt  từ  2,00 đến 2,49</td>
                    <td id="diem">2</td>
                    @if($bangdiem -> bangdiem_chitiet-> p1_a_3 == 2)
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> p1_a_3}}</td>
                    @else
                        <td id="diem">Không đủ</td>
                    @endif
                    <td id="diem"><input type="checkbox" name="p1_a_3" id="cb4" value="2" class="p1_cb" hidden></td>
                </tr>
                <tr>
                    <td id="dtb">ĐTBCHK dưới 2,00</td>
                    <td id="diem">0</td>
                    @if($bangdiem -> bangdiem_chitiet-> p1_a_3 == 0)
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> p1_a_3}}</td>
                    @else
                        <td id="diem">Không đủ</td>
                    @endif
                    <td id="diem"><input type="checkbox" name="p1_a_3" id="cb5" value="0" class="p1_cb" hidden></td>
                </tr>
                <tr>
                    ...
                    <td id="diem">2</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p1_a_4 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p1_a_4}}
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td id="diem">4</td>
                    @if($bangdiem -> bangdiem_chitiet-> chungchi_a == NULL)
                        <td id="diem">Chưa có</td>
                    @else
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> chungchi_a}}</td>
                    @endif
                    <td id="diem"><input type="checkbox" value="4" name="chungchi_a" id="chungchi_a" class="p1_cb" hidden></td>
                </tr>
                <tr>
                    <td>- Chứng chỉ B (và  tương đương)</td>
                    <td id="diem">5</td>
                    @if($bangdiem -> bangdiem_chitiet-> chungchi_b == NULL)
                        <td id="diem">Chưa có</td>
                    @else
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> chungchi_b}}</td>
                    @endif
                    <td id="diem"><input type="checkbox" value="5" name="chungchi_b" id="chungchi_b" class="p1_cb" hidden></td>
                </tr>
                <tr>
                    <td>- Chứng chỉ C (và  tương đương)</td>
                    <td id="diem">6</td>
                    @if($bangdiem -> bangdiem_chitiet-> chungchi_c == NULL)
                        <td id="diem">Chưa có</td>
                    @else
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> chungchi_c}}</td>
                    @endif
                    <td id="diem"><input type="checkbox" value="6" name="chungchi_c" id="chungchi_c" class="p1_cb" hidden></td>
                </tr>
                <tr>
                    <td>- Riêng chứng chỉ ngoại ngữ, Chứng nhận Toefl  ≥ 450 điểm; IELTS ≥ 4,5; TOEIC ≥ 450 điểm.</td>
                    <td id="diem">10</td>
                    @if($bangdiem -> bangdiem_chitiet-> toeic == NULL)
                        <td id="diem">Chưa có</td>
                    @else
                        <td id="diem">{{$bangdiem -> bangdiem_chitiet-> toeic}}</td>
                    @endif
                    <td id="diem"><input type="checkbox" value="10" name="toeic" id="toeic" class="p1_cb" hidden></td>
                </tr>
                <tr>
                    ...
                    <td id="diem"><input type="number" name="result1" class="tong" id="result1" readonly maxlength="2" hidden></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td id="diem">15</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p2_1 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p2_1}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem">10</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p2_2_1 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p2_2_1}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem">10</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p2_2_2 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p2_2_2}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem"><input name="result2" id="result2" class="tong" readonly maxlength="2" type="number" hidden></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td id="diem">12</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p3_1 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p3_1}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                                         ...
                                         value="0"
                                         @else
                                         value="{{$bangdiem -> bangdiem_chitiet-> p3_1}}"
                                         @endif
                                         readonly
                                         hidden
                        ></td>
                ...
                <tr>
                    ...
                    <td id="diem">4</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p3_2_1 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p3_2_1}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem">5</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p3_2_2 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p3_2_2}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem">6</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p3_3_1 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p3_3_1}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                                         ...
                                         value="0"
                                         @else
                                         value="{{$bangdiem -> bangdiem_chitiet-> p3_3_1}}"
                                         @endif
                                         readonly
                                         hidden
                        ></td>
                ...
                <tr>
                    ...
                    <td id="diem">8</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p3_3_2 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p3_3_2}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem">10</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p3_3_3 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p3_3_3}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem"><input name="result3" id="result3" class="tong" readonly maxlength="2" type="number" hidden></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td id="diem">6</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p4_1 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p4_1}}
                        @endif
                    </td>
                    <td id="diem"><input type="checkbox" value="6" name="p4_1" id="p4_1" class="p4_cb" hidden></td>
                </tr>
                <tr>
                    <td>- Có tinh thần giúp đỡ bạn bè trong học tập, trong cuộc sống </td>
                    <td id="diem">4</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p4_2 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p4_2}}
                        @endif
                    </td>
                    <td id="diem"><input type="checkbox" value="4" name="p4_2" id="p4_2" class="p4_cb" hidden></td>
                </tr>
                <tr>
                    ...
                    <td id="diem">10</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p4_3 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p4_3}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem"><input name="result4" id="result4" class="tong" readonly maxlength="2" type="number" hidden></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td id="diem">10</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p5_1 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p5_1}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem">6</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p5_2 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p5_2}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem">6</td>
                    <td id="diem">
                        @if($bangdiem -> bangdiem_chitiet-> p5_3 == NULL)
                            0
                        @else
                            {{$bangdiem -> bangdiem_chitiet-> p5_3}}
                        @endif
                    </td>
                    <td id="diem"><input placeholder="Nhập"
                                         type="number"
                ...
                <tr>
                    ...
                    <td id="diem"><input name="result5" id="result5" class="tong" readonly maxlength="2" type="number" hidden></td>
                </tr>
                <tr>
                    <td style="text-align: center"><strong>Cộng các mục 1,2,3,4,5</strong></td>
                    <td></td>
                    <td id="diem">{{$tong1 + $tong2 + $tong3 + $tong4 + $tong5}}</td>
                    <td id="diem"><input id="total" readonly maxlength="2" type="number" hidden></td>
                    <td><input type="button" class="sum" value="Cộng tổng" hidden></td>
                </tr>
                </tbody>
            </table>
        </div>
        ...
        <input id="submit" type="submit" value="Gửi bảng điểm" hidden>
    </form>
</div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.p3').on('change',function () {
            var sum_more = '<?php $bangdiem -> bangdiem_chitiet -> p3_1 + $bangdiem -> bangdiem_chitiet -> p3_3_1?>';
            var sum = 0;
            $(".p3").each(function(){
                sum += +$(this).val();
            });
