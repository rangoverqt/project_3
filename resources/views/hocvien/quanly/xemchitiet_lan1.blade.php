...
<div class="container">
    ...
    <div class="turnback"><a style="margin-right: 20px" href="
/doan3/public/hocvien/loptruong/bangdiem/{{$lop->id}}/suaduyet_lan1/{{$bangdiem -> id}}">Chấm lại</a></div>
    <div class="tt_sv">
